...
在侧边栏添加待办、日程或生日时，可以设置提醒：

- **待办事项**：可设置提醒间隔（如5分钟、15分钟、30分钟、1小时等），到期前按间隔重复提醒
- **日程安排**：
  - 可设置提前多久提醒（如5分钟、15分钟、30分钟、1小时、1天）
  - 可设置重复提醒间隔（如不重复、每5分钟、每15分钟、每小时）
- **生日提醒**：
  - 可设置提前多少天提醒（如1天、3天、7天、14天、30天）
  - 可设置重复提醒间隔（如不重复、每天、每周、每月）
